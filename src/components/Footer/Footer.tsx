...
const Footer: React.FC = () => {
  return (
    <footer className="footer flex flex-col items-center justify-center py-10 gap-6 text-white w-full" style={{ height: '200px', minHeight: '200px', maxHeight: '200px' }}>
      <h2 className="text-xl font-bold tracking-wide uppercase m-0" style={{ margin: 0, fontSize: '20px', fontWeight: 'bold', height: '24px', lineHeight: '1.2' }}>
        STUDY VAULT OF UIT
      </h2>

      <div className="footer-icons flex gap-6 items-center" style={{ height: '32px', gap: '24px' }}>
        {/* Facebook */}
        <a 
        ...
        {/* Email */}
        <a 
          href="mailto:contact@svuit.org" 
          target="_blank" 
          rel="noreferrer" 
          className="hover:opacity-80 transition-opacity"
          aria-label="Send email to contact@svuit.org"
        >
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 24 24" 
