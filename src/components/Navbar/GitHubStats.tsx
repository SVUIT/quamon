  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', lineHeight: '1.2' }}>
        ...
        <div style={{ display: 'flex', gap: '5px', fontSize: '10px', opacity: 0.7 }}>
          <span>{stats.version}</span> • <span>{stats.stars} Stars</span> • <span>{stats.forks} Forks</span>
        </div>
      </div>
    </a>
  );
